...
#URL = "https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=3&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2020&month=0&cweid=0&order=1&trc=126&sha=f801f330ee310a071b43395b244151d4fb234e06"
URLS = ["https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=1&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2021&month=0&cweid=0&order=1&trc=161&sha=28a2f51a672c94e4f5764cd0848d032c1497207f",
        "https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=2&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2021&month=0&cweid=0&order=1&trc=161&sha=28a2f51a672c94e4f5764cd0848d032c1497207f",
        "https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=3&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2021&month=0&cweid=0&order=1&trc=161&sha=28a2f51a672c94e4f5764cd0848d032c1497207f",
        "https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=4&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2021&month=0&cweid=0&order=1&trc=161&sha=28a2f51a672c94e4f5764cd0848d032c1497207f",
        "https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=1&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2022&month=0&cweid=0&order=1&trc=205&sha=ba801471883fb757c1345d508c515b19388c67e2",
        "https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=2&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2022&month=0&cweid=0&order=1&trc=205&sha=ba801471883fb757c1345d508c515b19388c67e2",
        "https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=3&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2022&month=0&cweid=0&order=1&trc=205&sha=ba801471883fb757c1345d508c515b19388c67e2",
        "https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=4&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2022&month=0&cweid=0&order=1&trc=205&sha=ba801471883fb757c1345d508c515b19388c67e2",
        "https://www.cvedetails.com/vulnerability-list.php?vendor_id=33&product_id=47&version_id=&page=5&hasexp=0&opdos=0&opec=0&opov=0&opcsrf=0&opgpriv=0&opsqli=0&opxss=0&opdirt=0&opmemc=0&ophttprs=0&opbyp=0&opfileinc=0&opginf=0&cvssscoremin=0&cvssscoremax=0&year=2022&month=0&cweid=0&order=1&trc=205&sha=ba801471883fb757c1345d508c515b19388c67e2"]
folder_index = 1
for URL in URLS:
    ...
    for text in url:
        ...
        if not os.path.exists(dir):
            ...
            print("Vulnerabilità "+str(folder_index)+" già scaricata")
        folder_index += 1
        # Estraggo i file
        if not (child_name == "") and not (parent_name == "") and tarfile.is_tarfile(os_path+folder_name+"/"+child_name) and tarfile.is_tarfile(os_path+folder_name+"/"+parent_name):
